classdef PhenomenologicalRateModel < RateNetwork
    % Class definition file for the phenomenological model.  Chloride
    % dynamic equation has been replaced by an abstract variable 'z', which
    % stands for the effectiveness of inhibition
    % 
    % Model = PhenomenologicalRateModel(template)
    %
    ...
    methods % Simulation functions
        function IndividualModelUpdate(O,dt) 
            ...
            V_inf = (O.param.g_L .* O.param.E_L  + ...
                     ...
                     O.z .* O.Input.I ./ O.param.f_max .* O.param.E_Cl + ...  
            ...
            % ----- Update equation 3 (inhibition effectiveness dynamics) ------ 
    ...
    methods 
        function O = PhenomenologicalRateModel(template)
