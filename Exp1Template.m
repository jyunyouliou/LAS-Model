%% This is a template for Figure 1 (2D rate)
%
% This template is actually exactly the same as the standard one.  However,
% to achieve better resolution for the movie & the 'simulated array 
% recording', resolution has been increased from 50 by 50 to 100 by 100.
% 
